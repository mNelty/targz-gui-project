...
This document outlines the guidelines for contributing to LibRARx.
## 🚀 How Can I Contribute?
There are many ways to contribute to LibRARx:
### 1. Reporting Bugs
 ...
 * Pull Request: When your changes are complete:
   ...
   * Open a Pull Request (PR) from your branch to the main LibRARx repository's main branch.
